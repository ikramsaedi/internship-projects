...
EMAIL="ikram.saedi@stileeducation.com"
API_TOKEN="U7XPO6SeOgbnc21L5xbe0D2A"
INSTANCE="stileeducation.atlassian.net"
DOWNLOAD_FOLDER="/Users/ikramsaedi/internship-2021/confluence-backup/backups"
...
if [ "$(echo "$BKPMSG" | grep -ic backup)" -ne 0 ]; then #-ne is not equal
